...
q = np.array([[0.6, 2, 4, 0.25, 5],
              [0.6, 2, 4, 0.25, 5]])
traj, t = GMM(same_target_dist=True).easgld_train(q, GMM.sgd, num_iterations=20*10**3, tau=10, step_size=0.25, moving_rate=0.01, gamma=1.0, epsilon=1e-3, batch_size=32)
